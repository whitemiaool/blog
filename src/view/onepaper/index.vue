...
export default {
    ...
    methods:{
        ...
        setP(item,index) {
            this.axios.post(API.getpapercom,{id:item._id,page:this.cp}).then((res)=>{
        ...
        clickstar(item,i) {
            this.axios.post(API.clickstar,{data:item._id,star:item.star}).then((res)=>{
