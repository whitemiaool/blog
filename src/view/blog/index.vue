                    ...
                    <div class="b-c-w">
                        <div class="b-c" :class="{'isfix':item.showFix}" :data-index="i" >
                            ...
                            <div class="b-c-c-w">
                                ...
                                <span class="b-c-c xin">
                                    <i class="icon iconfont icon-xin"></i>
                                    +1
                                    <span class="ls">+1s</span>
                                </span>
            ...
            <div class="r-b">
                <div class="r-b-t">
                    <div style="text-align: center;width: 100px;height:100%;display: table;">
                        <span style="display: table-cell;vertical-align: middle;"><img alt="" src="../../assets/ava.jpg" style="display: inline-block;"></span>
                    </div>
                    <div class="r-b-w">
